...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-calendar-tools/node_modules/calendar-tools/lib/atom.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-calendar-tools/node_modules/calendar-tools/lib/atom.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-calendar-tools/node_modules/calendar-tools/lib/</a> &#187; atom.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
module.exports.genEvent = <span class="fstat-no" title="function not covered" >function (ev, opts) {</span>
&nbsp;
  // default options
...
&nbsp;
  // timezone location
<span class="cstat-no" title="statement not covered" >  tz = options.timezone;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var orgEv = options,originalEvent;</span>
&nbsp;
